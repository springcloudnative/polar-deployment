...
GRANT ALL PRIVILEGES ON polardb_catalog.flyway_schema_history TO 'catalog_user'@'%';
GRANT ALL PRIVILEGES ON polardb_catalog.flyway_schema_history TO 'order_user'@'%';
