...
GRANT ALL PRIVILEGES ON polardb_catalog.catalog__flyway_schema_history TO 'catalog_user'@'%';
GRANT ALL PRIVILEGES ON polardb_catalog.orders TO 'order_user'@'%'';
GRANT ALL PRIVILEGES ON polardb_catalog.order__flyway_schema_history TO 'order_user'@'%';
